      ...
      >
        ...
        {!isUser && message.text && (
          <button
            ...
            className="shrink-0 self-center rounded-full bg-brand-50 px-4 py-1.5 text-sm font-semibold text-brand-600 shadow-sm transition-colors disabled:cursor-not-allowed disabled:opacity-60"
          >
